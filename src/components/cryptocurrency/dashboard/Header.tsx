            ...
            <div className="appHeader bg-primary text-light">
                ...
                <div className="right">
                    <a href="app-notifications.html" className="headerButton">
                        <img src={notificationBell} alt="image" className="imaged w32" />
                            ...
                            <a href="#" className="button" data-bs-toggle="modal" data-bs-target="#depositActionSheet">
                                <div className="icon-inner">
                                    ...
                                    >
                                        ...
                                        />
                                        <path
                                            d="M743.8053,130.05658H455.965v-8.40039a16.57376,16.57376,0,0,1,16.56-16.54981H727.24524a16.57369,16.57369,0,0,1,16.56006,16.54981Z" transform="translate(-219 -105.10638)"
                                            fill="#ccc"
                                        />
                                        <circle
                                            cx="267.06033"
